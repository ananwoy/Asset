...
<%@page import="com.cg.bean.Asset"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<title>AMS-Generate Report</title>
...
input[type=text], input[type=password], input[type=textarea], input[type=number]
	{
	color: #000000;
	padding-left: 10px;
	margin: 10px;
...
<body>
	...
	<div id="container2">
		<table>
			...
			<%
				...
				List<Asset> li = ad.generateReport("Available");
				for (Asset as : li) {
			%>
			<tr>
				<td><%=as.getAssetId()%></td>
				<td><%=as.getAssetName()%></td>
				<td><%=as.getAssetDes()%></td>
				<td><%=as.getQuantity()%></td>
				<td><%=as.getStatus()%></td>
			</tr>
			<%
				}
	...
	<div id="mySidenav" class="sidenav"
		...
		<a href="http://localhost:8080/CapsAsset/admin">Add Asset</a> <a class="active"
			href="http://localhost:8080/CapsAsset/status">View Requests</a> <a
			href="http://localhost:8080/CapsAsset/report">Generate Reports</a> <a
